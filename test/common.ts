...
export const validQueryCriterias = [{ center: new firebase.firestore.GeoPoint(0, 0), radius: 1000 }, { center: new firebase.firestore.GeoPoint(1, -180), radius: 1.78 }, { center: new firebase.firestore.GeoPoint(22.22, -107.77), radius: 0 }, { center: new firebase.firestore.GeoPoint(0, 0) }, { center: new firebase.firestore.GeoPoint(1, -180) }, { center: new firebase.firestore.GeoPoint(22.22, -107.77) }, { center: new firebase.firestore.GeoPoint(1, 2), radius: 2, query: (ref) => ref.where('d.count', '==', 1) }, { radius: 1000 }, { radius: 1.78 }, { radius: 0 }, { query: (ref) => ref.where('d.count', '==', 1) }, { query: null }];
export const invalidQueryCriterias = [{}, { random: 100 }, { center: { latitude: 91, longitude: 2 }, radius: 1000, random: 'a' }, { center: { latitude: 91, longitude: 2 }, radius: 1000 }, { center: { latitude: 1, longitude: -181 }, radius: 1000 }, { center: { latitude: 'a', longitude: 2 }, radius: 1000 }, { center: { latitude: 1, longitude: [1, 2] }, radius: 1000 }, { center: new firebase.firestore.GeoPoint(0, 0), radius: -1 }, { center: { latitude: null, longitude: 2 }, radius: 1000 }, { center: { latitude: 1, longitude: undefined }, radius: 1000 }, { center: { latitude: NaN, longitude: 0 }, radius: 1000 }, { center: new firebase.firestore.GeoPoint(1, 2), radius: -10 }, { center: new firebase.firestore.GeoPoint(1, 2), radius: 'text' }, { center: new firebase.firestore.GeoPoint(1, 2), radius: [1, 2] }, { center: new firebase.firestore.GeoPoint(1, 2), radius: null }, true, false, undefined, NaN, [], 'a', 1, { center: new firebase.firestore.GeoPoint(1, 2), radius: 2, query: false }, { center: new firebase.firestore.GeoPoint(1, 2), radius: 2, query: 23 }];
export const validGeoFirestoreObjects = [{ d: { coordinates: new firebase.firestore.GeoPoint(-23.5, -46.9) }, g: '6gydkcbqwf', l: new firebase.firestore.GeoPoint(-23.5, -46.9) }, { d: { coordinates: new firebase.firestore.GeoPoint(-73.5, 153) }, g: 'r7hg99g0yk', l: new firebase.firestore.GeoPoint(-73.5, 153) }, { d: { coordinates: new firebase.firestore.GeoPoint(52.3, 7.1) }, g: 'u1m198fj9f', l: new firebase.firestore.GeoPoint(52.3, 7.1) }];
export const invalidGeoFirestoreObjects = [{ d: null, g: '6gydkcbqwf', l: new firebase.firestore.GeoPoint(-23.5, -46.9) }, { d: { coordinates: new firebase.firestore.GeoPoint(-73.5, 153) }, g: false, l: new firebase.firestore.GeoPoint(-73.5, 153) }, { d: { coordinates: new firebase.firestore.GeoPoint(52.3, 7.1) }, g: 'u1m198fj9f', l: [52.3, 7.1] }];
