 ...
 *
 * A `GeoWriteBatch` object can be acquired by calling `GeoFirestore.batch()`. It
...
export class GeoWriteBatch {
  ...
  public set(
    ...
    (this._writeBatch as GeoFirestoreTypes.web.WriteBatch).set((documentRef as GeoFirestoreTypes.web.DocumentReference), encodeBatchDocument(data, (options) ? options.customKey : null), options);
    return this;
  }
   ...
   * @return This `GeoWriteBatch` instance. Used for chaining method calls.
   */
  public update(documentRef: GeoFirestoreTypes.cloud.DocumentReference | GeoFirestoreTypes.web.DocumentReference, data: GeoFirestoreTypes.cloud.DocumentData | GeoFirestoreTypes.web.DocumentData, customKey?: string): GeoWriteBatch {
    (this._writeBatch as GeoFirestoreTypes.web.WriteBatch).update(documentRef as GeoFirestoreTypes.web.DocumentReference, encodeBatchDocument(data, customKey));
    return this;
  }
