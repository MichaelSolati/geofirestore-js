...
[![npm version](https://badge.fury.io/js/geofirestore.svg)](https://badge.fury.io/js/geofirestore) [![Build Status](https://travis-ci.com/MichaelSolati/geofirestore-js.svg?branch=master)](https://travis-ci.com/MichaelSolati/geofirestore-js) [![Coverage Status](https://coveralls.io/repos/github/MichaelSolati/geofirestore-js/badge.svg?branch=master)](https://coveralls.io/github/MichaelSolati/geofirestore-js?branch=master) [![dependencies Status](https://david-dm.org/MichaelSolati/geofirestore-js/status.svg)](https://david-dm.org/MichaelSolati/geofirestore-js) [![star this repo](https://githubbadges.com/star.svg?user=geofirestore&repo=geofirestore-js&style=flat)](https://github.com/MichaelSolati/geofirestore-js) [![fork this repo](https://githubbadges.com/fork.svg?user=geofirestore&repo=geofirestore-js&style=flat)](https://github.com/MichaelSolati/geofirestore-js/fork)
